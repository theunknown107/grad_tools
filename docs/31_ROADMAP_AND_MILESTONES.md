...
browser; the integration suite asserts no student table exists. 424 tests pass,
46 of them against real PostgreSQL. Format, lint, typecheck and build are green;
